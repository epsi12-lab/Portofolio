...
\begin{center}
  ...
  {\color{accentcolor}\normalsize
   Systèmes d'Information \textbar{} Gestion de projet \textbar{}
   Développement logiciel \textbar{} Cybersécurité \textbar{} Data \& IA}\\[2pt]
  \small Alternant Master MIAGE, Université de Haute-Alsace\quad|\quad
         CNP Assurances\quad|\quad
         Depuis sept. 2026\\[2pt]
  \small
...
\section{Profil}
Alternant Master MIAGE au sein de CNP Assurances, je m'appuie sur une
formation en informatique généraliste et en réseaux pour contribuer à
l'évolution des systèmes d'information, tout en cultivant une pratique
technique diversifiée : sécurisation d'infrastructures, développement
d'applications distribuées et analyse de données.

\section{Formation}
\cventry{Master MIAGE en alternance}{Sept.~2026~--~2028}{%
CNP Assurances, Garges-lès-Gonesse (95)~--~Université de Haute-Alsace (UHA),
FST, Mulhouse (68)}{%
Contrat d'apprentissage, 15~j. université / 15~j. entreprise.}
...
\cventry{Opérateur logistique}{CDI\textbar{} 05/2022~--~08/2026}{%
LIDL, direction régionale~--~Strasbourg}{%
Application rigoureuse des procédures qualité~--~zéro incident signalé
sur 4 ans d'activité ; délais maintenus en coordination avec l'équipe.}
